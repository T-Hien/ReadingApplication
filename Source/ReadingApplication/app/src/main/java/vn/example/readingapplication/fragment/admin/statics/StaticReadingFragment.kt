...
import vn.example.readingapplication.adapter.admin.statics.StaticReadingAdapter
...
class StaticReadingFragment : BaseFragment(){

    private lateinit var binding: FragmentAdminStaticAuthorBinding
    private lateinit var adapter: StaticReadingAdapter
    private val itemList = mutableListOf<ReadingStatic>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.txtTitle1.setText("TK")
        adapter = StaticReadingAdapter(itemList,this)
