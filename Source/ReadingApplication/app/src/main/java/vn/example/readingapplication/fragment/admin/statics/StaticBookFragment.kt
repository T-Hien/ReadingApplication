...
import vn.example.readingapplication.adapter.admin.statics.StaticBookAdapter
...
class StaticBookFragment : BaseFragment(){

    private lateinit var binding: FragmentAdminStaticAuthorBinding
    private lateinit var adapter: StaticBookAdapter
    private val itemList = mutableListOf<Favorite>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = StaticBookAdapter(itemList,this)
